            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div id="introduction"><div class="box"><h1>Introduction</h1></div>
                        ...
                        <p>Use the <code>plain_page.php</code> and start right away building your own pages.</p>
                                                  ...
                                                  <ul class="nav side-menu">
                                                      <li><a><i class="fa fa-bug"></i> Additional Pages</i> <span class="fa fa-chevron-down"></span></a>
                                                          <ul class="nav child_menu">
                                                              ...
                                                              <li><a href="e_commerce_backend.php">E-commerce Backend</a></li>
                                                      ...
                                                      <li><a><i class="fa fa-windows"></i> Extras</i> <span class="fa fa-chevron-down"></span></a>
                                                          <ul class="nav child_menu">
                                                              ...
                                                              <li><a href="sign_up.php">SignUp Page</a></li>
                    ...
                    <div id="credits">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>E-Charts</td>
                                    <td><a href="http://echarts.baidu.com/doc/example-en.php">http://echarts.baidu.com/doc/example-en.php</a></td>
                                </tr>
                                <tr>
                                    <td>Font Awesome</td>
