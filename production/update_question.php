...
?>
<?php
$result = mysqli_query($conn,"SELECT * FROM questions WHERE id='" . $_GET['id'] . "'");
$row  = mysqli_fetch_array($result);
?>
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="form.php">Question Form</a></li>
										<li><a href="form_advanced.php">Advanced Components</a></li>
										<li><a href="form_validation.php">Registration Form</a></li>
			...
			<div class="right_col" role="main">
				<div class="">
					...
					<div class="x_panel">
						...
						<div class="x_content">
                          <form action="question_query.php" method="post">
							<div class="row" style="margin-left:0px;">
                                ...
                                <input type="hidden" class="form-control"  name="id" required="required" value="<?php echo $row['id'];?>"/>
								...
								<div class="col-md-4 col-sm-11  form-group" >
								<select class="form-control" name="experience" value="<?php echo $row['experience'];?>"required>
                                        ...
                                        ?>
                                        >Beginner</option>
										<option value="amature"
										<?php
                                        if($row['experience'] =='amature'){
                                            echo "selected";
                                        }
                                        ?>>Amature</option>
										<option value="advance"
										<?php
                                        if($row['experience'] =='advance'){
                                            echo "selected";
                                        }
                                        ?>>Advance</option>
									</select>
								...
								<div class="col-md-4 col-sm-11  form-group">
									...
									<select class="form-control" name="examtype" value=" echo $row['examtype'];?>" id="data" required>
										<option >Exam Type</option>
										<option value="Descriptive"
										<?php
                                        if($row['examtype'] =='Descriptive'){
                                            echo "selected";
                                        }
                                        ?>>Descriptive</option>
										<option value="MCQ"
								...
								<div class="col-md-12 col-sm-12  form-group">
									<textarea name="question" id="" cols="70" rows="3" class="form-control" placeholder="Enter Question here" value="<?php echo $row['question'];?>" required><?php echo $row['question'];?></textarea>
								</div>

								<div class="col-md-6 col-sm-12  form-group">
								A	
								<input type="text" placeholder="Option A" name="optiona" class="form-control" value="<?php echo $row['optiona'];?>"required>
								</div>

								<div class="col-md-6 col-sm-12  form-group">
								B	
								<input type="text" placeholder="Option B" name="optionb" class="form-control" value="<?php echo $row['optionb'];?>"required>
								</div>

								<div class="col-md-6 col-sm-12  form-group">
								C	
								<input type="text" placeholder="Option C" name="optionc" class="form-control" value="<?php echo $row['optionc'];?>"required>
								</div>

								<div class="col-md-6 col-sm-12  form-group">
								D	
								<input type="text" placeholder="Option D" name="optiond" class="form-control" value="<?php echo $row['optiond'];?>"required>
								</div>

								<div class="col-md-6 col-sm-12  form-group">
								
								<input type="text" name="correctans" placeholder="Select Correct Answer" class="form-control" value="<?php echo $row['correctans'];?>"required>
								</div>
