                                    ...
                                    <form class="" action="" method="post" novalidate>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <select class="form-control" name="role" id="data" required>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" name="firstname" required="required" placeholder="Your complete name"/>
                                            </div>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="gender" id="inlineRadio1" value="male" style="margin-left: 20px;">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" type="number" class='number' name="phone" maxlength="10" required='required'>
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Date Of Birth<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class='date' type="date" name="birthday" required='required'>
                                            </div>
                                        </div>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" type="password" name="cpassword" data-validate-linked='password' required='required' />
                                            </div>
                                        </div>
...
if (isset($_POST['submit_btn'])) {
    ...
    if ($numrows > 0) {
        ...
        if ($password == $cpassword) {
            ...
            $sql = "INSERT INTO adminuser(role,firstname,gender,email,phone,birthday,password) VALUES('$role','$firstname','$gender','$email','$phone','$birthday','$hash')";
