...
?>
<?php
$query  = "SELECT b.id,a.examcode,b.firstname,a.language,a.examtype,a.time,a.ques_no,a.schedule FROM  generated_exam a,adminuser b where b.id=a.user_id";
...
<?php
    ...
    while($result = mysqli_fetch_assoc($data)){
        ...
        <tr>
            ...
            <td>".$result['time']."</td>
            <td>".$result['ques_no']."</td>
            <td>".$result['schedule']."</td>
            
            <td><a href='update_exam.php?id=$result[id]'><i class='fa-solid fa-pen-to-square'></i></a>
            <a href='delete_data.php?id=$result[id]'><i class='fa fa-trash' aria-hidden='true'></i></a></td>
