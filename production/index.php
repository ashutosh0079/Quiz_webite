        ...
        <div class="right_col" role="main">
          ...
          <div class="tile_count">
            ...
            <div class="col-md-2 col-sm-4  tile_stats_count">
              ...
              <div class="count" style="margin-right:436px;">123.50</div>
            </div>
            <div class="col-md-2 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Total Questions</span>
              <div class="count green"><?php echo $rowcount1;?></div>
            </div>
            <div class="col-md-2 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Total Exams</span>
